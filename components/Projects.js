...
const Projects = () => {
  ...
  return (
    <div id="projects" className="w-full bg-gradient-to-b from-gray-50 to-white py-16">
          ...
          {data.map((project, id) => (
            ...
            >
              <Link href={`/projects/${project.id}`}>
                <div className="relative flex items-center justify-center h-auto w-full shadow-lg shadow-gray-200 rounded-xl p-4 group hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden">
